...
namespace projectOverlord
{
    ...
    public class statBlockPF
    {
        ...
        public int knwArca, knwDung, knwEngi, knwGeog,
                   ...
                   knwPlan, knwReli;
        //Trained Skill or not
        public bool     acroTrn, apprTrn, blufTrn, climTrn,
                        crafTrn, diplTrn, disaTrn, disgTrn,
                        escaTrn, flyTrn, handTrn, healTrn,
                        intiTrn, lingTrn, percTrn, perfTrn,
                        profTrn, rideTrn, sensTrn, sleiTrn,
                        spelTrn, steaTrn, survTrn, swimTrn,
                        useMTrn;
        public bool     arcaTrn, dungTrn, engiTrn, geogTrn,
                        histTrn, locaTrn, natuTrn, nobiTrn,
                        planTrn, reliTrn;
        ...
        public statBlockPF()
        {
            ...
            knwPlan = knwReli = 0;
            //Initialize Non-Knowledge Skill Trained Status
            acroTrn = apprTrn = blufTrn = climTrn = false;
            crafTrn = diplTrn = disaTrn = disgTrn = false;
            escaTrn = flyTrn = handTrn = healTrn = false;
            intiTrn = lingTrn = percTrn = perfTrn = false;
            profTrn = rideTrn = sensTrn = sleiTrn = false;
            spelTrn = steaTrn = survTrn = swimTrn = false;
            useMTrn = false;
            //Initialize Knowledge Skill Trained Status
            arcaTrn = dungTrn = engiTrn = geogTrn = false;
            histTrn = locaTrn = natuTrn = nobiTrn = false;
            planTrn = reliTrn = false;
        }
    ...
    class charStatList
    {
        ...
        public Boolean addEntry(statBlockPF newBlock)
        {
            ...
            while (current != null)
            {
                ...
                if (current.Value.blockID == newBlock.blockID)
                {               //If updating an entry
                    current.Value = newBlock;
                    return true;
                }
                else if (current.Value.blockID > newBlock.blockID)
                {         //Inserting within list
                    charList.AddBefore(current, newBlock);
                    return true;
                }
                else if (current == charList.Last)
